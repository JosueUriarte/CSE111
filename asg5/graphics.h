...
class window {
   ...
   private:
      ...
      static bool select_bool;
      static bool text_bool;

      static int pixel_movement;
   ...
   public:
      ...
      //Movement functions
      static void moveby(int pixels) {pixel_movement = pixels;}
      static void move_selected_object(float x, float y);

      //Border functions
      static void border(const string& clr, int thk)
         {  color = clr; 
            thickness = thk;}
      ...
      static bool selected(){ return select_bool; }
      static void set_selected(bool select){ select_bool = select; }

      //Fuction for numbers on objs
      static void draw_num(object, size_t);

      static bool is_text(){ return text_bool; }
      static void set_text(bool set){ text_bool = set; }
};
