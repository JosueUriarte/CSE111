...
class inode_state {
   ...
   public:
      ...
      base_file_ptr get_contents(inode_ptr point);

      void set_cwd(inode_ptr thatcwd)    {cwd = thatcwd;}
      void set_prompt(string thatprompt) {prompt_ = thatprompt;}
...
class base_file {
   ...
   public:
      ...
      virtual string get_file_type();
      virtual void print_dir();
      virtual void parent_helper (inode_ptr self, inode_ptr parent);
...
class plain_file: public base_file {
   ...
   public:
      ...
      virtual string get_file_type() {return "plain";}
...
class directory: public base_file {
   ...
   public:
      ...
      virtual void print_dir() override;
      virtual void parent_helper (inode_ptr self, 
                                    inode_ptr parent) override;
      
      virtual map<string,inode_ptr> get_dirents() override;
      virtual void set_contents(const map<string, inode_ptr>&) override;
      virtual string get_file_type() {return "dir";}
